...
--
-- Class LogEntry as table log_entries
--
...
--
-- Class MoodCommentNotification as table mood_comment_notifications
--
...
--
-- Class MoodPinComment as table mood_pin_comments
--
...
--
-- Class MoodPin as table mood_pins
--
...
--
-- Class ScheduledSession as table scheduled_sessions
--
...
--
-- Class UserMoodPin as table user_mood_pins
--
...
--
-- Class VideoPost as table video_posts
--
...
--
-- Class VideoSession as table video_sessions
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('echomirror_server', '20260303140148686', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260303140148686', "timestamp" = now();
