...
class GlobalEndpoint extends Endpoint {
  ...
  Future<String> generateClusterEncouragement(
    ...
    final messages = {
      'positive':
          'Great energy in your area! $nearbyCount others are feeling upbeat too.',
      'negative':
          'You\'re not alone—$nearbyCount others nearby understand. Many found short walks or deep breathing helped today.',
      'neutral':
          '$nearbyCount others nearby are taking it easy. Sometimes neutral is perfectly okay.',
      'excited':
          'The excitement is contagious! $nearbyCount others are feeling the same energy.',
      'calm': 'A peaceful moment shared by $nearbyCount others in your area.',
      'anxious':
          'Take a breath—$nearbyCount others nearby are working through similar feelings. You\'ve got this.',
    };
