...
class Endpoints extends EndpointDispatch {
  ...
  void initializeEndpoints(Server server) {
    var endpoints = <String, Endpoint>{
      ...
      'passwordReset': PasswordResetEndpoint()..initialize(server, 'passwordReset', null),
    };
      ...
      methodConnectors: {
        'streamMoodPins': MethodStreamConnector(
          ...
          call: (session, params, streamParams) async* {
            yield* (endpoints['global'] as GlobalEndpoint).streamMoodPins(session);
          },
        ),
        ...
        'generateClusterEncouragement': MethodConnector(
          ...
          call: (session, params) async {
            return (endpoints['global'] as GlobalEndpoint).generateClusterEncouragement(
              session,
              params['sentiment'],
              params['nearbyCount'],
            );
