...
export function InsightsPage() {
  ...
  // Derive mood drivers from suggestions if not provided by AI
  const moodDrivers: { label: string; percentage: number }[] = useMemo(() => {
    if (!currentInsight) return []
    // Try to extract from prediction text as fallback
        ...
        {isPending ? (
          ...
          <>
            ...
            <div style={{ marginTop: '1.25rem' }}>
              ...
              <TimeOfDayChip timeLabel="Morning" />
            </div>
            ...
            {currentInsight.suggestions.length > 0 && (
              <div style={{ marginTop: '1.25rem' }}>
                ...
                <RecommendationCards recommendations={currentInsight.suggestions} />
              </div>
            )}
                    ...
                    <div className="expanded-area" style={{ marginTop: '0.75rem' }}>
                      ...
                      {insight.suggestions.length > 0 && (
                        <div style={{ marginTop: '0.75rem' }}>
                          ...
                          <RecommendationCards recommendations={insight.suggestions} />
                        </div>
                      )}
