...
void main() {
  ...
  group('Multi-Device & Flaky Connectivity Convergence Simulation', () {
    test('multi-entity concurrent offline edits across Device A and Device B '
        'eventually converge with zero silently lost writes', () async {
      ...
      expect(
        server.logEntriesTable.containsKey('user_test:2026-08-29'),
        isTrue,
      );
      expect(
        server.followsTable.containsKey('user_test:user_friend_1'),
        isTrue,
      );
      ...
      expect(
        serverMoodLog['notes'],
        'Device B reflection: Calm evening reading and deep focus.',
      );
      ...
      expect(
        server.followsTable.containsKey('user_test:user_friend_2'),
        isTrue,
      );
